        ...
        <div className="flex-1 md:px-20">
          <div className="flex flex-col gap-2 p-4">
            <p className="text-titleColor font-bold text-center text-2xl">
              {" "}
              Tufan App – Account Deletion Request{" "}
            </p>
            <p className="text-center">
              {" "}
              If you would like to delete your Tufan account and all associated data,
              please call us, email us, or fill out the form on this page.
