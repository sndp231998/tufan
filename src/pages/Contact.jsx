			...
			<div className="flex flex-col gap-2 sm:flex-row justify-center">
				<div className="flex-1 md:px-20">
					<div className="flex flex-col gap-2 p-4">
						<p className="text-titleColor font-bold text-center text-2xl"> Contact Us </p>
						<p className="text-center"> We are here to help you in every way possible. Feel free to leave a message </p>
						<form className="pt-4">
							<div className="mb-4">
							...
							<div className="mb-4">
								...
								<select
									className="w-full text-sm font-medium mb-2 px-3 py-3 border bg-background rounded-md focus:outline-none focus:ring-2 focus:ring-blug-500 border-gray-300 ">
				...
				<div className="flex-1 md:p-6">
					<img src="https://s3-alpha-sig.figma.com/img/1b29/c35a/f43b05fd5bd44e626733169a8397abed?Expires=1738540800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=mjwhW1WHml2~KiByYPOjflq2IAK3G7CzbClJxtIoO1KiReJBNFkUUAKGQ~ksv5IKs57DPXoH2yGLSgvtD2lweEtW5FL5Oi32hdFc01p0f6F-QJb-099TlfLAGbK5a-OyjRCRFxfYzi1~Dh3PFwZQQsKJqceJociU0YMttrXNumg1csFN0ILI~Wenvmwey4g6VzVrTTtUq6A6aLuB0RBTcXCGfR5TQPTJjVasrj7KQCsDvpO3lt4JM1Scc7OS8y6mLax3V-b3DQThyJ1dhsXiUawP1VSzsuMRRW7WWPCn988cQ~aKhpjkPQFAtt~NtVQvOpAm7X-GoxnqXjzx7lHjag__" className="rounded-md w-full max-h-full" />
					<div className="flex gap-8 p-4">
						<p><mailIcon /> example@gmail.com</p>
						<p><phoneIcon />Ixample@gmail.com</p>
					</div>
				</div>
			</div>
		</div>
