      ...
      <div className="container mx-auto p-3">
        <div className="flex flex-wrap flex-col md:flex-row">
          <div className="flex-1 flex-col md:ml-20">
            <img
              className="w-32 m-0"
              src="https://s3-alpha-sig.figma.com/img/5de6/a92a/ad103c98bd5864a5aa3c541df43e466b?Expires=1738540800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Tad24VT0HgMU12Ww2quGs3JA6CIfd0wVi07QBEF1AeDsgXxh0m06S6w~DY0PUAMy7T4XczCifwAlEpZhUw37PQu7-05eNYsQf3YkrLlzag4Kp-SW4B9cgWDbklobaLlpDTvNaq4iXHi0IgDm-EOPeE4OXBXg8S68o~8M6VGm2mnSpfAybHlHWP3xgWy8xqxOL5Tji4TGD4~-7viy9876HO20TJT62hLAWDHUpFdnlfRnLfzde5rF4XcIwqUKyYheAQJ-n4K~fTUqJbj3bJeeqkeuqaNIYODLkPYtiovciUBD6x~dUqHnRC8fOBHfcOiRtwNuNn3r0KQt3EQQB~YmbA__"
            />
          </div>
